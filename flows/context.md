...
echo "private: $(node -p "try{require('./package.json').private||false}catch(e){'unknown'}")"
...
echo "unreleased_lines: $(sed -n '/## \[[Uu]nreleased\]/,/## \[/p' CHANGELOG.md 2>/dev/null | grep -c '[^ ]' || echo '0')"
